...
ADD_ICON(11,	1,	L"nethanium")				//Nethanium Tools
ADD_ICON(11,	2,	L"nethaniumSword")
ADD_ICON(11,	3,	L"nethaniumAxe")
ADD_ICON(11,	4,	L"nethaniumPickaxe")
ADD_ICON(11,	5,	L"nethaniumShovel")
ADD_ICON(11,	6,	L"nethaniumHoe")			//
...
ADD_ICON(12,	1,	L"nethanium_helmet")		//Nethanium Armor
ADD_ICON(12,	2,	L"nethanium_chestplate")
...
ADD_ICON(15,		11,	L"record_where are we now")
	...
	ADD_ICON(20,	0,	L"nether_log_top");
	ADD_ICON(20,	1,	L"planks_nether");
	ADD_ICON(20,	2,	L"nether_vine");
	ADD_ICON(20,	3,	L"nether_bricks_mossy");
