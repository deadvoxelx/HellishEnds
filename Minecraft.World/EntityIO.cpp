...
void EntityIO::staticCtor()
{
	...
	setId(Skeleton::create,		eTYPE_SKELETON,	L"Skeleton",	51 | ((Skeleton::TYPE_STRAY + 1) << 12),		eMinecraftColour_Mob_Skeleton_Colour2,	eMinecraftColour_Mob_Skeleton_Colour1,	IDS_STRAY);
