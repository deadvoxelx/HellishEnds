...
void IUIScene_CreativeMenu::staticCtor()
{
	...
	DEF(eCreativeInventory_BuildingBlocks)
		...
		ITEM(Tile::netherDiamond_Id)
		ITEM(Tile::nethaniumOre_Id)
		ITEM(Tile::endoriumOre_Id)
		...
		ITEM(Tile::netherPlanks_Id)
		ITEM(Tile::purulPlanks_Id)
		...
		ITEM(Tile::netherWood_Id)
		ITEM(Tile::purulLog_Id)
		ITEM(Tile::gravel_Id)
		...
		ITEM(Tile::netherBricksMossy_Id)
		ITEM(Tile::netherSoil_Id)
		ITEM(Tile::soulsand_Id)
		ITEM(Tile::lavaRock_Id)
		ITEM(Tile::glowstone_Id)
		ITEM(Tile::goldenclin_Id)
		ITEM(Tile::goldenclinBricks_Id)
		ITEM(Tile::fence_Id)
		...
		ITEM(Tile::mycel_Id)
		ITEM(Tile::endSand_Id)
		ITEM(Tile::endStone_Id)
		ITEM(Tile::endStoneMossy_Id)
		ITEM(Tile::veloettGrass_Id)
		ITEM(Tile::endStoneSmooth_Id)
		ITEM(Tile::endBricks_Id)
		ITEM(Tile::endBricksChiseled_Id)
		ITEM(Tile::endBricksMossy_Id)
...
//		ITEM_AUX(Tile::stoneSlabHalf_Id,StoneSlabTile::WOOD_SLAB)
	...
	DEF(eCreativeInventory_Decoration)
		...
		ITEM_AUX(Tile::leaves_Id, LeafTile::JUNGLE_LEAF)
			ITEM(Tile::netherLeaves_Id)
			ITEM(Tile::purulVeloett_Id)
		ITEM(Tile::vine)
	...
	DEF(eCreativeInventory_ToolsArmourWeapons)
		...
		ITEM(Item::nethaniumHelmet_Id)
		ITEM(Item::nethaniumChestplate_Id)
		...
		//ITEM(Item::endoriumHelmet_Id)
		//ITEM(Item::endoriumChestplate_Id)
	...
	DEF(eCreativeInventory_Materials)
		...
		ITEM(Item::nethanium_Id)
		ITEM(Item::endorium_Id)
		ITEM(Item::brick_Id)
