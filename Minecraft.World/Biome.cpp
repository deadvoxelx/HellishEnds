...
void Biome::staticCtor()
{
	...
	Biome::plains = (new PlainsBiome(1))->setColor(0x8db360)->setName(L"Plains")->setTemperatureAndDownfall(0.8f, 0.4f)->setDepthAndScale(0.1f, 1.0f)->setLeafFoliageWaterSkyColor(eMinecraftColour_Grass_Plains, eMinecraftColour_Foliage_Plains, eMinecraftColour_Water_Plains,eMinecraftColour_Sky_Plains);
	...
	Biome::extremeHills = (new ExtremeHillsBiome(3))->setColor(0x8db360)->setName(L"Extreme Hills")->setDepthAndScale(0.1f, 2)->setTemperatureAndDownfall(0.2f, 0.3f)->setLeafFoliageWaterSkyColor(eMinecraftColour_Grass_Plains, eMinecraftColour_Foliage_Plains, eMinecraftColour_Water_ExtremeHills,eMinecraftColour_Sky_ExtremeHills);
	...
	Biome::smallerExtremeHills = (new ExtremeHillsBiome(20))->setColor(0x8db360)->setName(L"Extreme Hills Edge")->setDepthAndScale(0.1f, 1.5f)->setTemperatureAndDownfall(0.2f, 0.3f)->setLeafFoliageWaterSkyColor(eMinecraftColour_Grass_Plains, eMinecraftColour_Foliage_Plains, eMinecraftColour_Water_ExtremeHillsEdge,eMinecraftColour_Sky_ExtremeHillsEdge);
